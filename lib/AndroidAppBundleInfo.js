...
(function() {
  ...
  AndroidAppBundleInfo = (function(superClass) {
    ...
    AndroidAppBundleInfo.prototype.getIconFile = function(callback) {
      ...
      lookupOrderedNew = ['**/mipmap-xxxhdpi*/icon.png', '**/drawable-xxxhdpi*/icon.png', '**/mipmap-xxhdpi*/icon.png', '**/drawable-xxhdpi*/icon.png', '**/mipmap-xhdpi*/icon.png', '**/drawable-xhdpi*/icon.png', '**/mipmap-hdpi*/icon.png', '**/drawable-hdpi*/icon.png', '**/mipmap-*/icon.png', '**/drawable-*/icon.png'];
      lookupOrdered.push.apply(lookupOrdered, lookupOrderedNew);
